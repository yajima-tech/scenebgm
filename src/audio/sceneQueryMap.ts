export const SCENE_QUERY_MAP: Record<string, { queries: string[] }> = {
  nyuure:  { queries: ['jazz piano lounge background elegant', 'guitar acoustic jazz cafe', 'bossa nova piano background'] },
